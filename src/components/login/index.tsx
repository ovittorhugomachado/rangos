...
const LoginContainer = () => {
    return (
        <>
            <main className="backdrop-blur-md bg-white/15 dark:bg-white/5 border-1 border-zinc-400 rounded-xl w-120 h-110 m-3 pt-25 pb-20 p-5 flex flex-col justify-center items-center">
