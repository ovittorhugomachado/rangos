...
const LoginContainer = () => {
    return (
        <>
            <main className="bg-amber-50 border-1 border-zinc-400 rounded-xl w-120 pt-15 pb-25 p-5 flex flex-col justify-center items-center">
                ...
                <a className="link" href="#">Ainda não tem conta? <strong>Criar conta <FaArrowRight className="inline" /></strong></a>
            </main>
        </>
    )
}
