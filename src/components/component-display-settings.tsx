...
export const ToggleThemeAndFont = ({
  ...
  return (
    <div className={`w-auto h-auto text-lg sm:text-xl rounded-l-xl border border-zinc-400 border-r-0 bg-white dark:bg-zinc-950 absolute top-[10px] right-0 z-60 flex flex-row sm:flex-col items-center justify-center gap-2.5 px-2 py-1 sm:py-2 backdrop-blur-sm text-black dark:text-white${!byStore ? " -translate-y-2" : ""}`}>
